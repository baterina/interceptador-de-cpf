...
export function BackgroundShapes() {
  ...
  return (
    <div
      className='bg pointer-events-none transform-gpu overflow-hidden'
      style={{ filter: `blur(7vw) hue-rotate(${hue}deg)` }}
      aria-hidden='true'
    >
      <div
        className='clip bg-gradient-to-r from-[#073366] to-white/10'
        style={{ clipPath: `polygon(${poly1})`, opacity: opacity }}
      />
      <div
        className='clip bg-gradient-to-t from-[#38a8e5] to-white/10'
        style={{ clipPath: `polygon(${poly2})`, opacity: 0.2 }}
      />
    </div>
  )
}
